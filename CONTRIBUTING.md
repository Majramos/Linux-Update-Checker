# Contributing to linux-update-checker
...
1. Check the [issue tracker](https://gitlab.com/majramos/linux-update-checker/-/work_items) to see if the bug has already been reported.
...
1. Check the [issue tracker](https://gitlab.com/majramos/linux-update-checker/-/work_items) for similar suggestions.
...
2. Clone your fork locally:
   ```bash
   git clone https://gitlab.com/<YOUR_USERNAME>/linux-update-checker.git
   cd linux-update-checker
   ```
...
git clone https://gitlab.com/majramos/linux-update-checker.git
cd linux-update-checker
